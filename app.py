...
# --- Load trained model and encoders ---
model = pickle.load(open(os.path.join(current_dir, "trained_model_rf.sav"), "rb"))
le_category = pickle.load(open(os.path.join(current_dir, "category_encoder.pkl"), "rb"))
le_gender = pickle.load(open(os.path.join(current_dir, "gender_encoder.pkl"), "rb"))
le_city = pickle.load(open(os.path.join(current_dir, "city_encoder.pkl"), "rb"))
le_state = pickle.load(open(os.path.join(current_dir, "state_encoder.pkl"), "rb"))
